...
下面是我写的脚本，为了便于理解，我将各个命令都分开写了。如果你也完成了这个任务，不妨share your code with me by sending your code to 'stevenslxie at gmail.com'。
...
当中新出现的`mv cp tr`等命令，就留待读者自己解决啦。这几个命令也是非常常用的哦~
