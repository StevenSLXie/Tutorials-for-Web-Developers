...
<li><a href="http://www.thegeekstuff.com/2009/09/unix-sed-tutorial-replace-text-inside-a-file-using-substitute-command/">6. The Geek Stuff</a></li>
</ul>
...
<h4>转载声明</h4>
如果你喜欢这篇文章，可以随意转载。但请1）标明原作者StevenSLXie; 2) 标明原链接（https://github.com/StevenSLXie/Shell-Programming-Tutorial/edit/master/%E6%95%99%E7%A8%8B.md）;3)在可能的情况下请保持文本显示的美观。比如，请不要直接一键复制到博客之类，因为代码的显示效果可能非常糟糕。谢谢合作。
